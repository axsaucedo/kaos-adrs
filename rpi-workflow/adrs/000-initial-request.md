...
- End-to-end verification is king. Playwright visual verification for intense component creation (reference: the OSS ports of the data-app creation and Playwright visual-verification companion skills landing in `EthicalML/agent-skills-marketplace`); kind-based Kubernetes validation as in the kaos repo for e2e cluster validation.
