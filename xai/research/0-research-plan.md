...
These two were worked out in the current session (with web verification) but exist only as analysis, not yet as documents. They are the C4/C5 core and should be written up next, as they carry the most novel and most load-bearing claims.
