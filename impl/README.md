...
This folder tracks the execution of the security and identity implementation defined by the phase split in [`../security-and-identity/plan/proposed-split.md`](../security-and-identity/plan/proposed-split.md).
...
- Follow the markdown style in [`../security-and-identity/CONVENTIONS.md`](../security-and-identity/CONVENTIONS.md): no hard line wraps inside paragraphs or list items.
